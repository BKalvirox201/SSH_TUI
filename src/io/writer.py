...
class SSHChannelWriter:
    ...
    def __init__(self, channel: SSHLineEditorChannel):
    ...
    def set_cursor_visibility(self, visible: bool):
        ...
        self.channel.write(f"\x1b[?25{'h' if visible else 'l'}")

    def set_alt_screen(self, enable: bool):
        """Enable or disable alternate screen buffer."""
        self.channel.write(f"\x1b[?1049{'h' if enable else 'l'}")

    def clear_screen(self):
        """Clear screen and move cursor to home."""
        self.channel.write("\x1b[2J\x1b[H")

    def set_window_title(self, title: str):
        """Set the terminal window title."""
        self.channel.write(f"\x1b]0;{title}\x07")
